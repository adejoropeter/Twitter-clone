...
const Compose = () => {
  ...
  return (
    <div className="w-full h-screen bg-[#242d34b3] fixed  z-50 overflow-y-hidden ">
      <div className="bg-black overflow-scroll sm:w-[600px] min-h-screen  sm:h-fit  top-[50%] left-[50%]  -translate-x-[50%] -translate-y-[50%] flex flex-col sm:rounded-2xl overflow-x-hidden relative ">
